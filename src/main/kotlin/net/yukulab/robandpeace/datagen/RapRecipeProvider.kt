...
class RapRecipeProvider(output: FabricDataOutput, registryFuture: CompletableFuture<RegistryWrapper.WrapperLookup>) : FabricRecipeProvider(output, registryFuture) {
    override fun generate(exporter: RecipeExporter) {
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, RapItems.SMOKE, 2)
            ...
            .offerTo(exporter)
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, RapItems.EXPLOSION_SMOKE, 2)
            .pattern("BSB")
            .pattern("SFS")
            .pattern("BSB")
            .input('B', Items.BONE_MEAL)
            .input('S', Items.STRING)
            .input('F', Items.TNT)
            .criterionHaveItem(Items.BONE_MEAL, Items.STRING, Items.TNT)
            .offerTo(exporter)
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, RapItems.FIRE_SMOKE, 2)
            .pattern("BSB")
            .pattern("SFS")
            .pattern("BSB")
            ...
            .input('S', Items.STRING)
            .input('F', Items.TNT)
            .criterionHaveItem(Items.BLAZE_POWDER, Items.STRING, Items.TNT)
            .offerTo(exporter)
